...
import com.example.justnews.util.Constants.Companion.QUERY_PAGE_SIZE
...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Adding ClickListener to newsAdapter, we need to put it in a bundle and call put serializable, after witch we can call findNavController
